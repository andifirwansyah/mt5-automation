...
RUNTIME_CONFIG_SEEDS: list[dict[str, Any]] = [
    ...
    {
        "config_key": "market_structure_override_min_confidence",
        "config_value": 0.70,
        "value_type": "float",
        "description": "Minimum signal confidence required to convert soft market-structure issues into warnings.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "market_structure_hard_min_room_atr",
        "config_value": 0.30,
        "value_type": "float",
        "description": "Critical minimum room-to-opposite-zone in ATR before hard reject.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "market_structure_soft_min_room_atr",
        "config_value": 0.80,
        "value_type": "float",
        "description": "Preferred minimum room-to-opposite-zone in ATR before soft warning/reject.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "market_structure_zone_tolerance_atr",
        "config_value": 0.45,
        "value_type": "float",
        "description": "Support/resistance zone tolerance in ATR.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "market_structure_danger_zone_atr",
        "config_value": 0.55,
        "value_type": "float",
        "description": "Distance to opposite support/resistance in ATR considered dangerous.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "market_structure_min_candles_required",
        "config_value": 30,
        "value_type": "int",
        "description": "Minimum candles required for market-structure analysis.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "session_filter_allowed_sessions",
        "config_value": "ASIA,LONDON,NEW_YORK",
        "value_type": "str",
        "description": "Comma-separated allowed UTC sessions: ASIA,LONDON,NEW_YORK,ROLLOVER.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "session_filter_block_rollover",
        "config_value": True,
        "value_type": "bool",
        "description": "Block trading during UTC rollover session.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "signal_quality_min_score",
        "config_value": 0.45,
        "value_type": "float",
        "description": "Minimum composite signal quality score required before validation.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
    {
        "config_key": "trade_cooldown_minutes",
        "config_value": 10,
        "value_type": "int",
        "description": "Cooldown minutes between generated signals for the same symbol/timeframe.",
        "is_active": True,
        "updated_by": "pytest",
        "update_reason": "seed default runtime config",
    },
