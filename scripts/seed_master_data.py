...
STRATEGY_SEEDS: list[dict] = [
    {
        ...
        "config": {
            ...
            "pullback_max_distance_atr": 0.8,
            "confirmation_min_body_atr": 0.3,
            "pullback_touch_required": True,
            "confirmation_bars": 2,
    ...
    },
    {
        ...
        "config": {
            ...
            "breakout_min_body_atr": 0.25,
            "min_breakout_range_atr": 1.0,
    ...
    },
    {
        ...
        "config": {
            "lot_size": 0.01,
            "reversion_threshold_atr": 0.6,
            "boundary_tolerance_atr": 0.2,
            "min_range_width_atr": 1.0,
            "reversion_min_body_atr": 0.15,
            "sl_atr_multiplier": 1.2,
